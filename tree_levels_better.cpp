...
// Funkcija za dodavanje cvora u stablo. Obratiti paznju na **,
// menjamo strukturu stabla i moramo da saljemo pokazivac na njega
// da bismo to mogli
...
int main ()
{
  ...
  std::vector<int> keys = {2, 1, 3, 5, 0, 7, 6, 4};
